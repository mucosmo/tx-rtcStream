...
module.exports.initializeWorkers = async () => {
  ...
  console.log('initializeWorkers() creating %d mediasoup workers', config.mediasoup.numWorkers);
...
module.exports.createTransport = async (transportType, router, options) => {
  switch (transportType) {
    ...
    case 'plain':
      return await router.createPlainTransport(config.mediasoup.plainTransportOptions);
  }
};
